      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {courses.map((course, index) => (
            <div
              key={index}
              className="group relative bg-white rounded-2xl border-2 border-gray-100 overflow-hidden hover:border-blue-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
            >
              ...
              <div className="p-8 pt-12">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="inline-block px-3 py-1 bg-gray-100 text-gray-700 text-sm font-medium rounded-full">
                    {course.level}
                  </div>
                </div>
